  ...
  <div class="row">
    <div class="col">
      <div class="pagamento-container">
        ...
        <form class="form-container" method="POST" name="cartao-form" action="">
          <div class="field-container">
            <label for="nome">Nome</label>
            <input id="nome" name="nome" maxlength="28" type="text" required>
          </div>
          ...
          <div class="field-container">
            ...
            <input id="validade" name="validade" type="text" inputmode="numeric" required>
          </div>

          <div class="field-container">
            <label for="codigo">Código de Segurança</label>
            <input id="codigo" name="codigo" type="text" inputmode="numeric" required>
          </div>

          <div class="field-container">
            <label for="parcelamento">Parcelamento</label>
            <select id="parcelamento" name="parcelamento" type="text" inputmode="numeric" required>
              <option value="1"><?='1x (R$ ' . number_format($resumo['Total'],2,",",".") . ')';?></option>
            </select>
          </div>

          <input class="hidden" id="bandeira" name="bandeira" type="text">

          <div class="button-pane" style="margin-top: 16px">
            <button id="pagar-btn" class="btn btn-color" type="submit">Pagar</button>
            <a href="<?=base_url('conta')?>" class="btn">Cancelar</a>
          </div>
        </form>
      </div>
    </div>
