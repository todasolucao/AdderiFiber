...
<form id="form1" action="autoriza_cartao_debito" class="form-container" method="POST">
            ...
            <input type="hidden" name="telefone" class="form-control  col-sm-10" value="00000000">
					...
					<div class="field-container" style="margin-top: 16px">
                        ...
                        <a href="https://adderi.todasolucao.com.br/" class="btn">Cancelar</a>
                    </div>
...
Mercadopago.setPublishableKey("TEST-a04a055c-8d6a-4966-b653-e2adf4073409");
